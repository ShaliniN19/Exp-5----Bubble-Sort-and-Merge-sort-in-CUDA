...
<img width="1736" height="323" alt="pca ex 5" src="https://github.com/user-attachments/assets/8effb574-e32a-4f69-83ad-1be4212f3d01" />

## result:

Thus, the program has been executed using CUDA to implement and analyze parallel Bubble Sort and Merge Sort algorithms on the GPU, compare their performance with CPU-based sorting, and study the efficiency and limitations of GPU parallelization for sorting operations.
